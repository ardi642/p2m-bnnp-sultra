...
use App\Models\P2mPemberdayaan; // Model Baru
use App\Models\SatuanKerja;
use App\Models\Pegawai;
use Illuminate\View\View;
use Illuminate\Http\Request;
use App\Exports\PemberdayaanExport; // Export Baru
...
class PemberdayaanController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        // View folder baru
        return view('p2m.pemberdayaan.index', compact('kegiatans', 'satuanKerjas', 'years', 'pegawais', 'user', 'satkerLookup', 'totalKegiatan', 'totalPeserta'));
    }
    ...
    public function create(): View
    {
        ...
        // View folder baru
        return view('p2m.pemberdayaan.create', compact('satuanKerjas', 'pegawais'));
    }
    ...
    public function store(Request $request, DokumenService $dokumenService)
    {
        ...
        $rules = [
            ...
            'sub_kegiatan'         => 'required|in:pembinaan,pemetaan,kapasitas,monev',
        ...
        $validDetails = [
            'pembinaan' => ['pembinaan_teknis_satker'],
            'pemetaan'  => ['pemetaan_sdm_sda', 'rapat_kerja'],
            'kapasitas' => ['bimtek_life_skill', 'pengukuran_skm'],
            'monev'     => ['monev_program', 'pengukuran_ikkrn', 'pengukuran_kuesioner'],
        ];

        if (
            !isset($validDetails[$validasi['sub_kegiatan']]) ||
            !in_array($validasi['detail_kegiatan'], $validDetails[$validasi['sub_kegiatan']])
        ) {

            return back()
                ->withErrors(['detail_kegiatan' => 'Detail tidak sesuai dengan sub kegiatan.'])
                ->withInput();
        }
        ...
        try {
            $validasi['sub_kegiatan'] = Str::slug($validasi['sub_kegiatan'], '_');
            $validasi['detail_kegiatan'] = Str::slug($validasi['detail_kegiatan'], '_');
    ...
    public function edit($id): View
    {
        ...
        // View Baru
        return view('p2m.pemberdayaan.edit', compact('kegiatan', 'satuanKerjas', 'pegawais', 'selectedPegawaiNips'));
    }
