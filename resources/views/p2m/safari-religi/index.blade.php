                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover mb-0" x-data="{ expanded: [] }">
                                    ...
                                    <tbody>
                                        @forelse ($safarireligi as $data)
                                            <tr class="text-center align-middle">
                                                <td>{{ $safarireligi->firstItem() + $loop->index }}</td>
                                                <td>{{ $data->satuan_kerja->satuan_kerja ?? '-' }}</td>
                                                <td>{{ $data->nama_desa }}</td>
                                                <td>{{ $data->nama_kota_kabupaten }}</td>
                                                <td>{{ \Carbon\Carbon::parse($data->tanggal_pencanangan)->format('d/m/Y') }}</td>
                                                <td>{{ $data->jumlah_penggiat_p4gn }}</td>
                                                <td>{{ $data->keberadaan_ibm }}</td>
                                                <td>{{ $data->nama_penanggung_jawab }}</td>
                                                <td>{{ $data->nomor_hp_penanggung_jawab }}</td>
