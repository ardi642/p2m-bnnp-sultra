                ...
                <div class="col-12 col-lg-10">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted mb-0">Perbarui Data Remaja Teman Sebaya</p>
                        </div>
                        <a href="{{ route('p2m.rts.index') }}" class="btn btn-outline-secondary d-flex align-items-center gap-2">
                ...
                <div class="col-12 col-lg-10">
                    <div class="card border-0 shadow-lg">
                        ...
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <form action="{{ route('p2m.rts.update', $kegiatan->id) }}" method="POST" enctype="multipart/form-data" id="form-edit">
                                @csrf
                                @method('PUT')
