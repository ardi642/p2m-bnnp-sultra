        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-10">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h1 class="h3 mb-1 fw-bold text-dark">Input Data TAT</h1>
                        <p class="text-muted mb-0">Tambah Data Tim Asesmen Terpadu</p>
                    </div>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white py-3 border-bottom">
                        <h5 class="card-title mb-0 fw-bold text-primary">Form Input Data</h5>
                    </div>
                    
                    <div class="card-body p-4 p-lg-5">
                        <form action="{{ route('berantas.tat.store') }}" method="POST" enctype="multipart/form-data" id="form-create">
                            @csrf
                            ...
                            <div class="row g-4 mb-5">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="no_register" class="form-control @error('no_register') is-invalid @enderror" value="{{ old('no_register') }}" placeholder="Masukkan nomor register">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="nama_tersangka" 
                                              ...
                                              x-init="resize()"
                                              @input="resize()"
                                              placeholder="Masukkan nama tersangka">{{ old('nama_tersangka') }}</textarea>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-6">
                                            ...
                                            <div class="input-group">
                                                <input type="number" name="usia" class="form-control @error('usia') is-invalid @enderror" value="{{ old('usia') }}" placeholder="0">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="pendidikan" class="form-control @error('pendidikan') is-invalid @enderror" value="{{ old('pendidikan') }}" placeholder="Masukkan pendidikan">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="no_telepon" class="form-control @error('no_telepon') is-invalid @enderror" value="{{ old('no_telepon') }}" placeholder="Masukkan nomor telepon">
                                    @error('no_telepon') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                </div>

                                <div class="col-12">
                                    <label class="form-label small fw-bold">Pekerjaan</label>
                                    <input type="text" name="pekerjaan" class="form-control @error('pekerjaan') is-invalid @enderror" value="{{ old('pekerjaan') }}" placeholder="Masukkan pekerjaan">
                            ...
                            <div class="row g-4 mb-5">
                                <div class="col-12">
                                    ...
                                    <textarea name="pasal_disangkakan" 
                                              ...
                                              x-init="resize()"
                                              @input="resize()"
                                              placeholder="Masukkan pasal yang disangkakan">{{ old('pasal_disangkakan') }}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="instansi_pengirim" class="form-control @error('instansi_pengirim') is-invalid @enderror" value="{{ old('instansi_pengirim') }}" placeholder="Masukkan nama instansi pengirim">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="tanggal_permohonan" class="form-control @error('tanggal_permohonan') is-invalid @enderror" value="{{ old('tanggal_permohonan') }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="jenis_narkoba" class="form-control @error('jenis_narkoba') is-invalid @enderror" value="{{ old('jenis_narkoba') }}" placeholder="Masukkan jenis narkoba">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="jumlah_barang_bukti" class="form-control @error('jumlah_barang_bukti') is-invalid @enderror" value="{{ old('jumlah_barang_bukti') }}" placeholder="Masukkan jumlah satuan">
                                    @error('jumlah_barang_bukti') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                </div>

                                <div class="col-12">
                                    <label class="form-label small fw-bold">Tanggal Penangkapan <span class="text-danger">*</span></label>
                                    <input type="date" name="tanggal_penangkapan" class="form-control @error('tanggal_penangkapan') is-invalid @enderror" value="{{ old('tanggal_penangkapan') }}">
                            ...
                            <div class="row g-4 mb-5">
                                <div class="col-md-6">
                                    ...
                                    <textarea name="tim_hukum" class="form-control @error('tim_hukum') is-invalid @enderror" rows="3" 
                                        x-data="{ resize() { $el.style.height = 'auto'; $el.style.height = $el.scrollHeight + 'px' } }"
                                        x-init="resize()" @input="resize()" placeholder="Masukkan nama tim hukum">{{ old('tim_hukum') }}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="tim_medis" class="form-control @error('tim_medis') is-invalid @enderror" rows="3"
                                        x-data="{ resize() { $el.style.height = 'auto'; $el.style.height = $el.scrollHeight + 'px' } }"
                                        x-init="resize()" @input="resize()" placeholder="Masukkan nama tim medis">{{ old('tim_medis') }}</textarea>
                                    @error('tim_medis') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label small fw-bold">Lembaga Rehab</label>
                                    <input type="text" name="lembaga_rehab" class="form-control" value="{{ old('lembaga_rehab') }}" placeholder="Masukkan lembaga rehab">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <select name="tindak_lanjut_rekomendasi" class="form-select">
                                        ...
                                        <option value="dilaksanakan" @selected(old('tindak_lanjut_rekomendasi') == 'dilaksanakan')>Dilaksanakan</option>
                                        <option value="tidak dilaksanakan" @selected(old('tindak_lanjut_rekomendasi') == 'tidak dilaksanakan')>Tidak Dilaksanakan</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="biaya" class="form-control" value="{{ old('biaya') }}" placeholder="0">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="proses_hukum_lanjut" 
                                              ...
                                              placeholder="Masukkan proses hukum lanjut">{{ old('proses_hukum_lanjut') }}</textarea>
                                </div>
                            </div>
