                ...
                <div class="col-12 col-lg-10">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted mb-0">Kegiatan P2M Integrasi Kurikulum Anti Narkotika (IKAN)</p>
                        </div>
                ...
                <div class="col-12 col-lg-10">
                    <div class="card border-0 shadow-lg">
                        ...
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <form action="{{ route('p2m.ikan.store') }}" method="POST" enctype="multipart/form-data" id="form-create">
                                @csrf
