  ...
  <main class="admin-main" x-data="p2mIndex">
        <div class="container-fluid p-4 p-lg-5">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-1 fw-bold text-dark">Kegiatan Car Free Day (CFD)</h1>
                    <p class="text-muted mb-0">Master Data Pelaksanaan CFD</p>
                </div>


                   @if (auth()->user()->hasRole(['operator_satker', 'operator_p2m']))
                <a href="{{ route('p2m.cfd.create') }}" class="btn btn-primary btn-lg fs-6 px-4 rounded-pill shadow-sm d-flex align-items-center gap-2">
            ...
            @php
                // TAMBAHAN: 'anggaran_pelaksanaan' KE ARRAY FILTER
                    ...
                    <div class="card border-0 shadow-sm"> 
                        <div class="card-header bg-white py-3 border-bottom">
                            <div class="d-flex flex-column flex-lg-row justify-content-between align-items-center gap-2">
                                <h5 class="card-title mb-0 fw-bold text-secondary"><i class="bi bi-table me-2"></i>Data CFD</h5>
                        ...
                        <div class="card-body p-0 p-lg-4">
                            ...
                            <form action="{{ route('p2m.cfd.index') }}" method="GET">
                                    ...
                                    <div class="bg-body-tertiary p-4 rounded-3 border">
                                        <div class="row g-3 text-start">
                                            ...
                                            <div class="col-12 text-end pt-3 border-top mt-4 text-start">
                                                <a href="{{ route('p2m.cfd.index') }}" class="btn btn-link text-decoration-none text-muted btn-sm me-2">Reset</a>
                                ...
                                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-end align-items-lg-center mb-3 px-3 px-lg-0">
                                    ...
                                    <div class="mb-2 mb-lg-0">
                                        <button type="submit" formaction="{{ route('p2m.cfd.export') }}" class="btn btn-success btn-sm text-white d-flex align-items-center gap-2 px-3 shadow-none">
                                    ...
                                    <tbody class="border-top-0">
                                        @forelse ($cfds as $data)
                                            <tr class="text-center align-middle" :class="isExpanded({{ $data->id }}) ? 'bg-light' : ''">
                                                <td class="fw-bold text-secondary ps-3">{{ $cfds->firstItem() + $loop->index }}</td>
                                            ...
                                            <td class="text-start">
                                                ...
                                                <td class="text-start small">{{ $data->tempat_kegiatan }}</td>
                                                ...
                                                <td class="pe-3">
                                                    ...
                                                    @if (auth()->user()->hasRole(['operator_satker', 'operator_p2m']))
                                                        <a href="{{ route('p2m.cfd.edit', $data->id) }}" class="btn btn-light border text-primary" title="Edit"><i class="bi bi-pencil-square"></i></a>
                                                        ...
                                                        <form id="delete-form-{{ $data->id }}" action="{{ route('p2m.cfd.destroy', $data->id) }}" method="POST" class="d-none">@csrf @method('DELETE')</form>
                                                    @endif
                                                    </div>
                                                </td>
                                            </tr>
                                        ...
                                        @empty
                                            <tr><td colspan="10" class="text-center py-5 text-muted fst-italic border-bottom">Tidak ada data kegiatan.</td></tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="card-footer bg-white py-3 border-top-0">
                                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-center gap-3">
                                    ...
                                    <div>{{ $cfds->withQueryString()->links() }}</div>
                                </div>
                            </div>
