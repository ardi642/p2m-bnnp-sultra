...
use App\Models\P2mPemetaanSdmSda;
use App\Models\SatuanKerja;

/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\P2mPemetaanSdmSda>
 */
class P2mPemetaanSdmSdaFactory extends Factory
{
    /**
     ...
     * @var string
     */
    protected $model = P2mPemetaanSdmSda::class;
