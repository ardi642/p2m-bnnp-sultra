...
class P2mMonev extends Model
{
    use HasFactory;
    use HasDokumen; // Trait untuk dokumen/link

    protected $table = 'p2m_monev';
     ...
     * Menggunakan tabel pivot 'pegawai_p2m_monev'
     */
    public function pegawai(): BelongsToMany
    {
        return $this->belongsToMany(
            Pegawai::class,                 // Model Tujuan
            'pegawai_p2m_monev',// Nama Tabel Pivot
            'p2m_monev_id',     // FK di Pivot (id kegiatan)
