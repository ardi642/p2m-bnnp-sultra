...
use App\Exports\CfdExport; // Import Export Class
...
class CfdController extends Controller
{
    ...
    private function getFilteredQuery(Request $request)
    {
        ...
        $query = p2mcfd::with('pegawai', 'satuanKerja');
        ...
        $allowSort = ['tanggal_pelaksanaan', 'tempat_kegiatan', 'jumlah_peserta', 'created_at', 'satuan_kerja'];
    ...
    public function index(Request $request): View {
        ...
        $years = p2mcfd::selectRaw('YEAR(tanggal_pelaksanaan) as year')->distinct()->orderBy('year', 'desc')->pluck('year');
        ...
        $cfds = $query->paginate($perPage)->withQueryString();
                        
        return view('p2m.cfd.index', compact('cfds', 'satuanKerjas', 'years', 'pegawais', 'user'));
    }
    ...
    public function export(Request $request) 
    {
        ...
        return Excel::download(new CfdExport($query), 'Laporan_P2M_Car free day.xlsx');
    }
