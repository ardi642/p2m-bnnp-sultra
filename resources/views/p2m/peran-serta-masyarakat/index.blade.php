...
<main class="admin-main" x-data="p2mIndex">
    <div class="container-fluid p-4 p-lg-5">
        ...
        @php
            $allFilters = request()->only(['satuan_kerja_id', 'bulan', 'tahun', 'anggaran_pelaksanaan', 'kategori_kegiatan', 'search', 'pegawai_nips']);
                    ...
                    <div class="card-body p-0 p-lg-4">
                                ...
                                <div class="bg-body-tertiary p-4 rounded-3 border">
                                    <div class="row g-3 text-start">
                                        ...
                                        <div class="col-12 col-lg-3">
                                            ...
                                            <div class="shadow-sm bg-white rounded">
                                                <select id="select-kategori" name="kategori_kegiatan[]" multiple placeholder="Pilih Kategori..." autocomplete="off">
                                                    <option value="pembinaan_teknis" {{ in_array('pembinaan_teknis', request('kategori_kegiatan', [])) ? 'selected' : '' }}>Pembinaan Teknis</option>
                                                    <option value="pemetaan_kelompok_sasaran" {{ in_array('pemetaan_kelompok_sasaran', request('kategori_kegiatan', [])) ? 'selected' : '' }}>Pemetaan Kelompok Sasaran</option>
                                                    <option value="pengembangan_kapasitas" {{ in_array('pengembangan_kapasitas', request('kategori_kegiatan', [])) ? 'selected' : '' }}>Pengembangan Kapasitas</option>
                                                    <option value="monitoring_evaluasi" {{ in_array('monitoring_evaluasi', request('kategori_kegiatan', [])) ? 'selected' : '' }}>Monitoring & Evaluasi</option>
                                                </select>
                                            </div>
                                        </div>
                        ...
                        @if($totalKegiatan == 0)
                            <div class="alert alert-info alert-dismissible fade show mb-3" role="alert">
                                ...
                                <strong>Tidak ada data</strong> - Coba input data kegiatan baru atau ubah filter pencarian
                            ...
                            <table class="table table-hover align-middle mb-0">
                                <thead class="bg-light sticky-top">
                                    <tr class="text-center align-middle small text-uppercase text-secondary">
                                        <th class="py-3 bg-light ps-3" style="width: 50px">No</th>
                                        <th class="py-3 bg-light" style="width: 120px">{!! $sortLink('kategori_kegiatan', 'Kategori') !!}</th>
                                        ...
                                        <th class="py-3 bg-light text-center" style="width: 80px">{!! $sortLink('jumlah_peserta', 'Peserta') !!}</th>
                                        <th class="py-3 bg-light pe-3 text-center" style="width: 80px">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody class="border-top-0">
                                    @forelse ($kegiatans as $data)
                                        ...
                                        <tr class="text-left align-middle" :class="isExpanded({{ $data->id }}) ? 'bg-light' : ''">
                                            ...
                                            {{-- KOLOM PEGAWAI --}}
                                            <td class="text-start text-nowrap small">
                                                @php
                                                    $pegawaiCount = $data->pegawai->count();
                                                @endphp
                                                @if($pegawaiCount > 0)
                                                    <span class="badge bg-primary bg-opacity-10 text-primary">{{ $pegawaiCount }} Pegawai</span>
                                                @else
...
<script type="module">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        if(typeof TomSelect !== 'undefined'){
            ...
            const ids = ['select-satker', 'select-bulan', 'select-anggaran', 'select-kategori', 'select-tahun', 'select-pegawai'];
