                                ...
                                <div class="row g-4 mb-5">
                                            ...
                                            <select class="form-select @error('satuan_kerja_id') is-invalid @enderror"
                                                ...
                                                @foreach ($satuanKerjas as $satker)
                                                    <option value="{{ $satker->id }}"
                                                        @selected(old('satuan_kerja_id', $pasien->satuan_kerja_id) == $satker->id)>
                                                        {{ $satker->satuan_kerja }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    @else
                                        <div class="col-12">
                                            ...
                                            <input type="hidden" name="satuan_kerja_id" value="{{ auth()->user()->getSatkerId() }}">
                                            <input type="text" class="form-control" value="{{ auth()->user()->pegawai?->satuanKerja?->satuan_kerja ?? '-' }}" disabled>
                                        </div>
                                    @endif
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select class="form-select @error('narkotika_id') is-invalid @enderror"
                                            ...
                                            @foreach ($narkotikas as $narkotika)
                                                <option value="{{ $narkotika->id }}" @selected(old('narkotika_id', $pasien->narkotika_id) == $narkotika->id)>
