                ...
                <div class="col-12 col-lg-10">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted mb-0">Kegiatan P2M Peran Serta Masyarakat</p>
                        </div>
                ...
                <div class="col-12 col-lg-10">
                    <div class="card border-0 shadow-lg">
                        ...
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <form action="{{ route('p2m.peran-serta-masyarakat.store') }}" method="POST" enctype="multipart/form-data" id="form-create">
                                @csrf
                                ...
                                <div class="row g-4 mb-5">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <select class="form-select @error('kategori_kegiatan') is-invalid @enderror" name="kategori_kegiatan" id="kategori-kegiatan">
                                            <option value="" disabled selected>-- Pilih Kategori --</option>
                                            <option value="pembinaan_teknis" @selected(old('kategori_kegiatan') == 'pembinaan_teknis')>Pembinaan Teknis</option>
                                            <option value="pemetaan_kelompok_sasaran" @selected(old('kategori_kegiatan') == 'pemetaan_kelompok_sasaran')>Pemetaan Kelompok Sasaran</option>
                                            <option value="pengembangan_kapasitas" @selected(old('kategori_kegiatan') == 'pengembangan_kapasitas')>Pengembangan Kapasitas & Pembinaan</option>
                                            <option value="monitoring_evaluasi" @selected(old('kategori_kegiatan') == 'monitoring_evaluasi')>Monitoring dan Evaluasi</option>
                                        </select>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <select class="form-select @error('nama_kegiatan') is-invalid @enderror" name="nama_kegiatan" id="nama-kegiatan">
                                ...
                                <div class="row g-4 mb-4">
                                    <div class="col-12 col-lg-8">
                                        ...
                                        {{-- DEBUG: Pegawais Count = {{ count($pegawais) }} --}}
...
<script type="module">
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // Mapping jenis kegiatan berdasarkan kategori
        ...
        // Update select dropdown when kategori changes
        const kategoriSelect = document.getElementById('kategori-kegiatan');
        const namaSelect = document.getElementById('nama-kegiatan');

        function updateNamaKegiatanList() {
            const selectedKategori = kategoriSelect.value;
            namaSelect.innerHTML = '<option value="" disabled selected>-- Pilih Nama Kegiatan --</option>';

            if (selectedKategori && jenisKegiatanMap[selectedKategori]) {
                jenisKegiatanMap[selectedKategori].forEach(namaKegiatan => {
                    const option = document.createElement('option');
                    option.value = namaKegiatan;
                    option.textContent = namaKegiatan;
                    namaSelect.appendChild(option);
                });
            }
        }

        kategoriSelect.addEventListener('change', updateNamaKegiatanList);
        updateNamaKegiatanList(); // Initialize on load
