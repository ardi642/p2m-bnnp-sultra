...
class PelatihanController extends Controller
{
    ...
    private function getFilteredQuery(Request $request)
    {
        ...
        $query = P2mPelatihan::with('pegawai.satuanKerja', 'satuanKerja');
        ...
        if (in_array($sortBy, $allowSort)) {
            if ($sortBy === 'satuan_kerja') {
                $query->join('satuan_kerja', 'p2m_pelatihan.satuan_kerja_id', '=', 'satuan_kerja.id')
                        ->orderBy('satuan_kerja.satuan_kerja', $sortOrder)
                        ->select('p2m_pelatihan.*');
            } else {
    ...
    public function index(Request $request): View 
    {
        ...
        $yearQuery = P2mPelatihan::selectRaw('YEAR(tanggal_pelaksanaan) as year');
        ...
        return view('p2m.pelatihan.index', compact('pelatihans', 'satuanKerjas', 'years', 'pegawais', 'user', 'satkerLookup', 'totalKegiatan', 'totalPeserta'));
    }
    ...
    public function create(): View 
    {
        ...
        return view('p2m.pelatihan.create', compact('satuanKerjas', 'pegawais'));
    }
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            $kegiatan = P2mPelatihan::create($dataKegiatan);
        ...
        return redirect()->route('p2m.pelatihan.index')->with('success', 'store')->with('message', 'Berhasil menambahkan data.');
    }
    ...
    public function edit($id): View 
    {
        /** @var \App\Models\User $user */
        $user = Auth::user();
        $kegiatan = P2mPelatihan::with('pegawai')->findOrFail($id);
        ...
        return view('p2m.pelatihan.edit', compact('kegiatan', 'satuanKerjas', 'pegawais', 'selectedPegawaiNips'));
    }
    ...
    public function update(Request $request, $id) 
    {
        /** @var \App\Models\User $user */
        $user = Auth::user();
        $kegiatan = P2mPelatihan::findOrFail($id);
        ...
        try {
            ...
            // Sync Pegawai
            $oldPivotData = DB::table('pegawai_p2m_pelatihan')->where('p2m_pelatihan_id', $id)->get()->keyBy('pegawai_nip');
            ...
            return redirect()->route('p2m.pelatihan.index')->with('success', 'update')->with('message', 'Data berhasil diperbarui');
    ...
    {
        $query = $this->getFilteredQuery($request);
        return Excel::download(new PelatihanExport($query), 'Laporan_P2M_Pelatihan.xlsx');
    }
