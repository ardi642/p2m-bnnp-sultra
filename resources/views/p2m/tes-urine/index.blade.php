                        ...
                        <div class="card-body p-0 p-lg-4">
                            ...
                            <form action="{{ route('p2m.tes-urine.index') }}" method="GET">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3 px-3 px-lg-0">
                                    <button type="submit" formaction="{{ route('p2m.tes-urine.export') }}" class="btn btn-success btn-sm text-white d-flex align-items-center gap-2 shadow-sm">
                                        <i class="bi bi-file-earmark-excel"></i> <span class="d-none d-lg-inline">Export Excel</span>
                                    </button>
                                    <div class="text-muted small fst-italic">
                                        Total Data: <strong>{{ $kegiatans->total() }}</strong>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div class="custom-table-scroll mb-3" id="data-table">
                                <table class="table table-hover align-middle mb-0" x-data="{ expanded: [] }">
                                    ...
                                    <tbody class="border-top-0">
                                        ...
                                        @empty
                                            <tr><td colspan="11" class="text-center py-5 text-muted fst-italic border-bottom">Belum ada data kegiatan Tes Urine.</td></tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            </div>
