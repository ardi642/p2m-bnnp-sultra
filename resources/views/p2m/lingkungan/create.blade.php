                    ...
                    <div class="card shadow-lg p-5">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h5 class="card-title mb-2 text-center" id="judul">Input Data Lingkungan Bersinar yang telah Terbentuk</h5>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('p2m.lingkungan.store') }}" method="POST">
                                ...
                                <div class="row g-8 mb-5">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label">Sasaran</label>
                                            <select class="form-select @error('sasaran_kegiatan') is-invalid @enderror" aria-label="Default select example" name="sasaran">
                                                <option value="" selected>pilih sasaran</option>
                                                <option value="Sekolah/Kampus Bersinar" @selected(old('sasaran') == 'Sekolah/Kampus Bersinar')>Sekolah/Kampus Bersinar</option>
                                                <option value="Pondok Pesantren Bersinar" @selected(old('sasaran') == 'Pondok Pesantren Bersinar')>Pondok Pesantren Bersinar</option>
                                                <option value="Tempat Hiburan Bersinar" @selected(old('sasaran') == 'Tempat Hiburan Bersinar')>Tempat Hiburan Bersinar</option>
                                                <option value="Tempat Wisata Bersinar" @selected(old('sasaran') == 'Tempat Wisata Bersinar')>Tempat Wisata Bersinar</option>
                                                <option value="Industri Bersinar" @selected(old('sasaran') == 'Industri Bersinar')>Industri Bersinar</option>
                                            </select>
                                            @error('sasaran')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                ...
                                <div class="row g-8 mb-5">
                                    <div class="col-12 col-lg-6">
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label">Nama Tempat/Wilayah/Instansi</label>
                                            <textarea class="form-control @error('nama_tempat') is-invalid @enderror" rows="2" placeholder="masukkan nama tempat" name="nama_tempat" value="{{ old('nama_tempat') }}"></textarea>
                                            @error('nama_tempat')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label">Tanggal Pencanangan/Pengukuhan</label>
                                ...
                                <div class="row g-8 mb-5">
                                    <div class="col-12 col-lg-6">
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label">Jumlah Penggiat P4GN yang Terbentuk</label>
                                ...
                                <div class="row g-8 mb-5">
                                    <div class="col-12 col-lg-6">
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label">Nomor HP Penanggung Jawab Wilayah Bersinar</label>
                                            <input type="text" class="form-control @error('nomor_hp') is-invalid @enderror" placeholder="masukkan nomor hp penanggung jawab" name="nomor_hp" value="{{ old('nomor_hp') }}">
                                            @error('nomor_hp')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
