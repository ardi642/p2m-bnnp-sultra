                    ...
                    <div class="card border-0 shadow-sm"> 
                        <div class="card-header bg-white py-3 border-bottom">
                            <div class="d-flex flex-column flex-lg-row justify-content-between align-items-center gap-2">
                                <h5 class="card-title mb-0 fw-bold text-secondary"><i class="bi bi-table me-2"></i>Data Pembina Upacara</h5>
                        ...
                        <div class="card-body p-0 p-lg-4">
                            ...
                            {{-- FORM FILTER --}}
                            <form action="{{ route('p2m.upacara.index') }}" method="GET">
                                        ...
                                        <div class="row g-3 text-start">
                                            ...
                                            <div class="{{ $user->isAdmin() ? 'col-lg-8' : 'col-12' }}">
                                                ...
                                                <div class="input-group shadow-sm">
                                                    ...
                                                    <input type="text" name="search" class="form-control border-start-0 ps-0" placeholder="Cari Nama Sekolah, dll..." value="{{ request('search') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 text-end pt-3 border-top mt-4 text-start">
                                                <a href="{{ route('p2m.upacara.index') }}" class="btn btn-link text-decoration-none text-muted btn-sm me-2">Reset</a>
                                ...
                                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-end align-items-lg-center mb-3 px-3 px-lg-0">
                                    ...
                                    <div class="mb-2 mb-lg-0">
                                        <button type="submit" formaction="{{ route('p2m.upacara.export') }}" class="btn btn-success btn-sm text-white d-flex align-items-center gap-2 px-3 shadow-none">
                                    ...
                                    <tbody class="border-top-0">
                                        @forelse ($upacaras as $data)
                                            <tr class="text-center align-middle" :class="expanded.includes({{ $data->id }}) ? 'bg-light' : ''">
                                                ...
                                                <td><span class="fw-bold">{{ $data->jumlah_peserta_upacara }}</span></td>
                                                ...
                                                <td class="pe-3">
                                                    <div class="btn-group btn-group-sm shadow-sm">
                                                        ...
                                                        @if (auth()->user()->hasRole(['operator_satker', 'operator_p2m']))
                                                            <a href="{{ route('p2m.upacara.edit', $data->id) }}" class="btn btn-light border text-primary" title="Edit"><i class="bi bi-pencil-square"></i></a>
                                                            ...
                                                            <form id="delete-form-{{ $data->id }}" action="{{ route('p2m.upacara.destroy', $data->id) }}" method="POST" class="d-none">@csrf @method('DELETE')</form>
                                                        @endif
                                                    </div>
                                                </td>
                                            </tr>
                                        ...
                                        @empty
                                            <tr><td colspan="9" class="text-center py-5 text-muted fst-italic border-bottom">Tidak ada data kegiatan.</td></tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="card-footer bg-white py-3 border-top-0">
                                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-center gap-3">
                                    ...
                                    <div>{{ $upacaras->withQueryString()->links() }}</div>
                                </div>
                            </div>
