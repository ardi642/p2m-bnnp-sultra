                    ...
                    <div class="card border-0 shadow-sm"> 
                        <div class="card-header bg-white py-3 border-bottom">
                            <div class="d-flex flex-column flex-lg-row justify-content-between align-items-center gap-2">
                                <h5 class="card-title mb-0 fw-bold text-secondary"><i class="bi bi-table me-2"></i>Data KIE Keliling</h5>
                        ...
                        <div class="card-body p-0 p-lg-4">
                                        ...
                                        <div class="row g-3 text-start">
                                            ...
                                            <div class="{{ $user->isAdmin() ? 'col-lg-8' : 'col-12' }}">
                                                ...
                                                <div class="input-group shadow-sm">
                                                    ...
                                                    <input type="text" name="search" class="form-control border-start-0 ps-0" placeholder="Cari Tempat Kegiatan, dll..." value="{{ request('search') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 text-end pt-3 border-top mt-4 text-start">
                                                <a href="{{ route('p2m.kie.index') }}" class="btn btn-link text-decoration-none text-muted btn-sm me-2">Reset</a>
                                                ...
                                                <td class="text-start">
                                                    <a href="#" class="text-decoration-none fw-bold text-dark" 
                                                       @click.prevent="expanded.includes({{ $data->id }}) ? expanded = expanded.filter(id => id !== {{ $data->id }}) : expanded.push({{ $data->id }})">
                                                        {{ Str::limit($data->tempat_kegiatan, 60) }}
                                                    </a>
                                                </td>
                            ...
                            <div class="card-footer bg-white py-3 border-top-0">
                                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-center gap-3">
                                    ...
                                    <div>{{ $kies->withQueryString()->links() }}</div>
                                </div>
                            </div>
