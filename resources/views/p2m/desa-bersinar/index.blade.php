                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-hover mb-0" x-data="{ expanded: [] }">
                                    ...
                                    <tbody>
                                        @forelse ($desaBersinar as $data)
                                            {{-- Baris Utama --}}
                                            <tr class="text-center align-middle">
                                                <td>{{ $desaBersinar->firstItem() + $loop->index }}</td>
                                                <td>{{ $data->satuanKerja->satuan_kerja ?? '-' }}</td>
                                                <td>{{ $data->nama_desa ?? '-' }}</td>
                                                <td>{{ $data->nama_kota_kabupaten ?? '-' }}</td>
                                                <td>
                                                    {{ \Carbon\Carbon::parse(time: $data->tanggal_pencanangan)->translatedFormat('d F Y') }}
                                                </td>
                                                <td>{{ $data->jumlah_penggiat_p4gn }}</td>
                                                <td>{{ $data->keberadaan_ibm }}</td>
                                                                    ...
                                                                    <div class="mb-0">
                                                                        ...
                                                                        <div class="d-flex align-items-center mt-2">
                                                                            ...
                                                                            @if($data->link_dokumentasi)
                                                                                <a href="{{ $data->link_dokumentasi }}" target="_blank" class="text-decoration-underline text-break text-primary fw-semibold">
