                ...
                <div class="col-12 col-lg-10">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted mb-0">Kegiatan P2M Media Elektronik</p>
                        </div>
                        <a href="{{ route('p2m.elektronik.index') }}" class="btn btn-outline-secondary d-flex align-items-center gap-2">
                ...
                <div class="col-12 col-lg-10">
                    <div class="card border-0 shadow-lg">
                        ...
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <form action="{{ route('p2m.elektronik.store') }}" 
                                  method="POST" 
                                ...
                                <div class="row g-4 mb-5">
                                            ...
                                            <select class="form-select @error('satuan_kerja_id') is-invalid @enderror" 
                                                ...
                                                @foreach ($satuanKerjas as $satuanKerja)
                                                    <option value="{{ $satuanKerja->id }}" 
                                                            @selected(old('satuan_kerja_id') == $satuanKerja->id)>
                                    ...
                                    <div class="col-12 col-lg-{{ auth()->user()->isAdmin() ? '6' : '12' }}">
                                        ...
                                        <select class="form-select @error('anggaran_pelaksanaan') is-invalid @enderror" 
                                            ...
                                            <option value="DIPA" @selected(old('anggaran_pelaksanaan') == 'DIPA')>
                                                DIPA
                                            </option>
                                            <option value="NON DIPA" @selected(old('anggaran_pelaksanaan') == 'NON DIPA')>
                                                NON DIPA
                                            </option>
                                        </select>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select class="form-select @error('jenis_media') is-invalid @enderror" 
                                            ...
                                            @foreach(['televisi', 'radio', 'video tron', 'bioskop', 'tv plasma', 'media lain'] as $jm)
                                                <option value="{{ $jm }}" @selected(old('jenis_media') == $jm)>
                                                    {{ ucwords($jm) }}
                                                </option>
                                            @endforeach
                                        </select>
...
{{-- Styles & Scripts Sama Seperti Sebelumnya --}}
@push('styles')
