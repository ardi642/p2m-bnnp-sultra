                            ...
                            <form action="{{ route('rehab.pasien.store') }}" method="POST" id="form-create">
                                ...
                                <div class="row g-4 mb-5">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" value="Otomatis dibuat setelah disimpan"
                                            disabled>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select id="select-narkotika" name="narkotika_id[]" multiple autocomplete="off"
                                            ...
                                            @foreach ($narkotikas as $narkotika)
                                                <option value="{{ $narkotika->id }}" @selected(collect(old('narkotika_id'))->contains($narkotika->id))>
