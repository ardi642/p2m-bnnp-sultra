            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        {{-- PERUBAHAN 1: Tombol Kembali menggunakan url()->previous() --}}
                        {{-- Ini akan mengembalikan user ke link terakhir (termasuk filter pencarian di index) --}}
                    ...
                    <div class="card shadow-lg p-5">
                        <div class="card-header">
                            <h5 class="card-title mb-2">Edit Data Sosialisasi</h5>
                        </div>
                        <div class="card-body">
                            ...
                            <form id="form-edit-p2m" action="{{ route('p2m.sosialisasi.update', $kegiatan->id) }}" method="POST">
                                ...
                                <div class="row g-6 mb-5">
                                    {{-- ... (Semua Input Field biarkan sama seperti kode Anda sebelumnya) ... --}}
                                    
                                    {{-- Saya singkat kode inputnya agar fokus ke perubahan tombol di bawah --}}
                                ...
                                <div class="row justify-content-end">
                                    ...
                                    <div class="col-12 col-lg-auto">
                                        {{-- PERUBAHAN 2: Tombol Batal diganti menjadi Button type="reset" --}}
                                        {{-- Tombol ini akan mengembalikan semua inputan ke value awal (data dari database) --}}
...
<script type="module">
    document.addEventListener("DOMContentLoaded", function() {
        if(typeof TomSelect !== 'undefined'){
            ...
            // PERUBAHAN 3: Event Listener untuk Tombol Reset
            // Ketika form di-reset, Tom Select secara visual tidak otomatis berubah.
            // Kita perlu memaksa sinkronisasi (sync) agar tampilan kembali ke data awal database.
            const form = document.getElementById('form-edit-p2m');
            
            form.addEventListener('reset', function() {
                // Beri jeda 10ms agar proses native reset HTML selesai dulu, baru sync Tom Select
                setTimeout(() => {
