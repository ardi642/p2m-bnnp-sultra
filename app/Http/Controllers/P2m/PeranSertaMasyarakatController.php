...
class PeranSertaMasyarakatController extends Controller
{
    private function getFilteredQuery(Request $request)
    {
        ...
        $allowSort = ['anggaran_pelaksanaan', 'nama_kegiatan', 'kategori_kegiatan', 'tanggal_pelaksanaan', 'tempat_kegiatan', 'jumlah_peserta', 'created_at', 'satuan_kerja'];
    ...
    public function index(Request $request): View
    {
        ...
        return view('p2m.peran-serta-masyarakat.index', compact('kegiatans', 'satuanKerjas', 'years', 'pegawais', 'user', 'satkerLookup', 'totalKegiatan', 'totalPeserta'));
    }
    ...
    public function create(): View
    {
        ...
        return view('p2m.peran-serta-masyarakat.create', compact('satuanKerjas', 'pegawais'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('p2m.peran-serta-masyarakat.edit', compact('kegiatan', 'satuanKerjas', 'pegawais', 'selectedPegawaiNips'));
    }
