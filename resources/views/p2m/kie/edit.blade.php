                ...
                <div class="col-12 col-lg-10">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted mb-0">Perbarui Data KIE Keliling</p>
                        </div>
                        <a href="{{ route('p2m.kie.index') }}" class="btn btn-outline-secondary d-flex align-items-center gap-2">
                ...
                <div class="col-12 col-lg-10">
                    <div class="card border-0 shadow-lg">
                        ...
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <form action="{{ route('p2m.kie.update', $kegiatan->id) }}" method="POST" enctype="multipart/form-data" id="form-edit">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row g-4 mb-5">
                                    ...
                                    {{-- Tempat Kegiatan (Textarea) --}}
                                    <div class="col-12">
                                        <label class="form-label fw-semibold text-secondary small">Tempat Kegiatan / Rute <span class="text-danger">*</span></label>
                                        <textarea class="form-control @error('tempat_kegiatan') is-invalid @enderror" name="tempat_kegiatan" rows="3" placeholder="Masukkan detail lokasi atau rute KIE Keliling...">{{ old('tempat_kegiatan', $kegiatan->tempat_kegiatan) }}</textarea>
                                        @error('tempat_kegiatan') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>
                                </div>


                                {{-- SECTION 2: PERSONIL & BUKTI FISIK --}}
                                <h6 class="text-uppercase text-secondary fw-bold small mb-3 border-bottom pb-2">
                                    ...
                                    <div class="col-12 col-lg-8">
                                        ...
                                        <select id="select-pegawai" name="pegawai_nips[]" multiple placeholder="Pilih pegawai..." autocomplete="off">
                                            ...
                                            @foreach ($pegawais as $pgw)
                                                {{-- Cek apakah pegawai ini terpilih (ada di old input ATAU di data database) --}}
                                                @php 
                                                    $isSelect = collect(old('pegawai_nips', $selectedPegawaiNips))->contains($pgw->nip); 
                                                @endphp
                                    ...
                                    <div class="col-12 mt-3">
                                        <div class="bg-light p-4 rounded-3 border border-dashed">
                                            ...
                                            @if($kegiatan->dokumentasi->count() > 0)
                                                ...
                                                {{-- Hidden Input Container (Untuk menyimpan ID file yang akan dihapus) --}}
