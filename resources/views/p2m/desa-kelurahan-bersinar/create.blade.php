                ...
                <div class="col-12 col-lg-10">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted mb-0">Kegiatan P2M Desa/Lingkungan Bersinar</p>
                        </div>
                ...
                <div class="col-12 col-lg-10">
                    <div class="card border-0 shadow-lg">
                        ...
                        <div class="card-body p-4 p-lg-5">
                            <form action="{{ route('p2m.desa-kelurahan-bersinar.store') }}" method="POST" enctype="multipart/form-data" id="form-create">
                                @csrf
                                ...
                                <div class="row g-4 mb-5">
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control @error('nama_desa_kelurahan') is-invalid @enderror" name="nama_desa_kelurahan" value="{{ old('nama_desa_kelurahan') }}" placeholder="Masukkan nama desa">
