    ...
    <div class="container-fluid p-4 p-lg-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                ...
                <p class="text-muted mb-0">Master Data Pemetaan SDM dan SDA</p>
            </div>

            {{-- BAGIAN KANAN: Tombol Tambah Data --}}
            @if (auth()->user()->hasRole(['operator_satker', 'operator_p2m']))
                <a href="{{ route('p2m.pemetaan-sdm-sda.create') }}" class="btn btn-primary btn-lg fs-6 px-4 rounded-pill shadow-sm d-flex align-items-center gap-2">
                ...
                <div class="card border-0 shadow-sm"> 
                    <div class="card-header bg-white py-3 border-bottom">
                        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-center gap-2">
                            <h5 class="card-title mb-0 fw-bold text-secondary"><i class="bi bi-table me-2"></i>Data Pemetaan SDM dan SDA</h5>
                    ...
                    <div class="card-body p-0 p-lg-4">
                        ...
                        {{-- FORM FILTER --}}
                        <form action="{{ route('p2m.pemetaan-sdm-sda.index') }}" method="GET">
                                ...
                                <div class="bg-body-tertiary p-4 rounded-3 border">
                                    <div class="row g-3 text-start">
                                        ...
                                        <div class="col-12 text-end pt-3 border-top mt-4 text-start">
                                            <a href="{{ route('p2m.pemetaan-sdm-sda.index') }}" class="btn btn-link text-decoration-none text-muted btn-sm me-2">Reset</a>
                            ...
                            <div class="d-flex flex-column flex-lg-row justify-content-between align-items-end align-items-lg-center mb-3 px-3 px-lg-0">
                                <div class="mb-2 mb-lg-0">
                                    <button type="submit" formaction="{{ route('p2m.pemetaan-sdm-sda.export') }}" class="btn btn-success btn-sm text-white d-flex align-items-center gap-2 px-3 shadow-none">
                                        ...
                                        <tr class="text-center align-middle" :class="isExpanded({{ $data->id }}) ? 'bg-light' : ''">
                                            ...
                                            <td class="pe-3">
                                                <div class="btn-group btn-group-sm shadow-sm">
                                                    ...
                                                    @if (auth()->user()->hasRole(['operator_satker', 'operator_p2m']))
                                                        <a href="{{ route('p2m.pemetaan-sdm-sda.edit', $data->id) }}" class="btn btn-light border text-primary" title="Edit"><i class="bi bi-pencil-square"></i></a>
                                                        ...
                                                        <form id="delete-form-{{ $data->id }}" action="{{ route('p2m.pemetaan-sdm-sda.destroy', $data->id) }}" method="POST" class="d-none">@csrf @method('DELETE')</form>
                                                    @endif
                                                </div>
                                            </td>
                                        </tr>
