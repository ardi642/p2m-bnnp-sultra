                ...
                <div class="col-12 col-lg-10">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            ...
                            <p class="text-muted mb-0">Input Data Sosialisasi sebagai Pembina Upacara</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card shadow-lg p-5">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h5 class="card-title mb-2 text-center" id="judul">Input Data Sosialisasi P4GN melalui kegiatan upacara/apel di sekolah</h5>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('p2m.upacara.store') }}" method="POST">
                                @csrf
                                <div class="row g-6 mb-5"> 
                                   ...
                                   @if ($pegawai == null)    
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label">Tanggal Pelaksanaan
                                                Kegiatan</label>
                                            <input type="date"
                                                class="form-control @error('tanggal_pelaksanaan') is-invalid @enderror"
                                                placeholder="masukkan tanggal pelaksanaan" name="tanggal_pelaksanaan"
