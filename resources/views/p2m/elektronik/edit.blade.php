                ...
                <div class="col-12 col-lg-10">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted mb-0">Perbarui Data Media Elektronik</p>
                        </div>
                ...
                <div class="col-12 col-lg-10">
                    <div class="card border-0 shadow-lg">
                        ...
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <form action="{{ route('p2m.elektronik.update', $kegiatan->id) }}" 
                                  method="POST" 
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select class="form-select @error('jenis_media') is-invalid @enderror" 
                                            ...
                                            @foreach(['televisi', 'radio', 'video tron', 'bioskop', 'tv plasma', 'media lain'] as $jm)
                                                <option value="{{ $jm }}" 
                                                        @selected(old('jenis_media', $kegiatan->jenis_media) == $jm)>
                                                    {{ ucwords($jm) }}
                                                </option>
                                            @endforeach
                                        </select>
