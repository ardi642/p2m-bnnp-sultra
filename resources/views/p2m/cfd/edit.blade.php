            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="{{ route('p2m.cfd.index') }}" class="btn btn-outline-secondary btn-sm">
                ...
                <div class="col-12 col-lg-10">
                    <div class="card shadow-lg p-5">
                        <div class="card-header">
                            <h5 class="card-title mb-2">Edit Data Sosialisasi Pada Lokasi Car Free Day</h5>
                        </div>
                        <div class="card-body">
                            {{-- Form Edit --}}
                            <form id="form-edit-p2m" action="{{ route('p2m.cfd.update', $kegiatan->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row g-6 mb-5">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="mb-0">
                                           <label class="form-label fw-bold">Jumlah Peserta Tersosialisasi</label>
                                ...
                                <div class="row justify-content-end">
                                    ...
                                    <div class="col-12 col-lg-auto">
                                        ...
                                        <a href="{{ route('p2m.cfd.edit', $kegiatan->id) }}" class="btn btn-secondary w-100 mb-4 mb-lg-0">
                                            Reset Data
                                        </a>
                                    </div>
                                </div>
