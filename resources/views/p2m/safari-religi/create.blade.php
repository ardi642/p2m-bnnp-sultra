    ...
    <div class="container-fluid p-4 p-lg-5">
        ...
        <div class="row justify-content-center mb-4">
            <div class="col-12 col-lg-10">
                <h1 class="h3 mb-1 fw-bold text-dark">Input Kegiatan Safari Religi</h1>
                <p class="text-muted mb-0">Kegiatan P2M Safari Religi</p>
            </div>
        </div>
            ...
            <div class="col-12 col-lg-10">
                <div class="card border-0 shadow-lg">
                    ...
                    <div class="card-body p-4 p-lg-5">
                        <form 
                            action="{{ route('p2m.safari-religi.store') }}" 
                            method="POST" 
                                ...
                                <div class="col-12 col-lg-8">
                                    ...
                                    <select id="select-pegawai" name="pegawai_nips[]" multiple placeholder="Pilih pegawai..." autocomplete="off">
                                        ...
                                        @foreach ($pegawais as $pgw)
                                            <option 
                                                value="{{ $pgw->nip }}" 
                                                @selected(collect(old('pegawai_nips'))->contains($pgw->nip))
                                            >
                                                {{ $pgw->nama }} ({{ $pgw->nip }})
                                            </option>
                                        @endforeach
