                ...
                <div class="col-12 col-lg-10">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted mb-0">Perbarui Data Pemberdayaan Alternatif</p>
                        </div>
                ...
                <div class="col-12 col-lg-10">
                    <div class="card border-0 shadow-lg">
                        ...
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <form action="{{ route('p2m.pemberdayaan.update', $kegiatan->id) }}" method="POST"
                                ...
                                <div class="row g-4 mb-5" x-data="{
                                    subKegiatan: '{{ old('sub_kegiatan', $kegiatan->sub_kegiatan ?? '') }}',
                                    detailKegiatan: '{{ old('detail_kegiatan', $kegiatan->detail_kegiatan ?? '') }}',
                                    ...
                                    get filteredDetails() {
                                        return this.detailOptions[this.subKegiatan] ?? [];
                                    },
                                    ...
                                    init() {
                                        ...
                                        // Ensure options ter-render dengan proper sebelum validate
                                        this.$nextTick(() => {
                                            // Validasi apakah detailKegiatan sesuai dengan subKegiatan
                                            if (this.subKegiatan && this.detailKegiatan && !this.filteredDetails.find(d => d.value === this.detailKegiatan)) {
                                                this.detailKegiatan = '';
                                            }
                                        });
                                        
                                        // Watcher untuk monitoring perubahan subKegiatan
                                        this.$watch('subKegiatan', () => {
                                            if (!this.filteredDetails.find(d => d.value === this.detailKegiatan)) {
                                                this.detailKegiatan = '';
                                            }
                                        });
                                    }
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="sub_kegiatan" class="form-select" x-model="subKegiatan" required
                                            @change="detailKegiatan = ''">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold">Detail Kegiatan</label>

                                        <select name="detail_kegiatan" class="form-select" x-model="detailKegiatan"
                                            :disabled="!subKegiatan">

                                            <option value="">-- Pilih Detail Kegiatan --</option>

                                            <template x-for="option in filteredDetails" :key="option.value">
                                                <option :value="option.value" :selected="detailKegiatan === option.value" x-text="option.label"></option>
                                            </template>
                                        </select>
                                    </div>
                                ...
                                <div class="row g-4 mb-5">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select class="form-select @error('sasaran_kegiatan') is-invalid @enderror"
                                            ...
                                            <option value="lingkungan pemerintah" @selected(old('sasaran_kegiatan', $kegiatan->sasaran_kegiatan) == 'lingkungan pemerintah')>Lingkungan
                                                Pemerintah</option>
                                            <option value="lingkungan pendidikan" @selected(old('sasaran_kegiatan', $kegiatan->sasaran_kegiatan) == 'lingkungan pendidikan')>Lingkungan
                                                Pendidikan</option>
                                            <option value="lingkungan masyarakat" @selected(old('sasaran_kegiatan', $kegiatan->sasaran_kegiatan) == 'lingkungan masyarakat')>Lingkungan
                                                Masyarakat</option>
                                            <option value="lingkungan swasta" @selected(old('sasaran_kegiatan', $kegiatan->sasaran_kegiatan) == 'lingkungan swasta')>Lingkungan
                                                Swasta</option>
                                        </select>
                                            ...
                                            @foreach ($pegawais as $pgw)
                                                @php
                                                    $isSelect = collect(
                                                        old(
                                                            'pegawai_nips',
                                                            $kegiatan->pegawai->pluck('nip')->toArray(),
                                                        ),
                                                    )->contains($pgw->nip);
                                                @endphp
