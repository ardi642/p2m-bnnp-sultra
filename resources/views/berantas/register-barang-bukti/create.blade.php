                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                                ...
                                <div class="col-2">
                                    <button type="button" 
                                        ...
                                        <span x-show="!isLoading">
                                            <i class="bi bi-geo-alt-fill"></i> <span class="d-none d-md-inline">GPS</span>
                                        </span>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="lokasi_perolehan" class="form-control py-2" rows="2" placeholder="Masukkan alamat lengkap TKP...">{{ old('lokasi_perolehan') }}</textarea>
