                                ...
                                <div class="row g-4 mb-5">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <select class="form-select @error('kategori_kegiatan') is-invalid @enderror" name="kategori_kegiatan" id="kategori-kegiatan">
                                            ...
                                            <option value="pembinaan_teknis" @selected(old('kategori_kegiatan', $kegiatan->kategori_kegiatan) == 'pembinaan_teknis')>1. Pembinaan Teknis</option>
                                            <option value="pemetaan_kelompok_sasaran" @selected(old('kategori_kegiatan', $kegiatan->kategori_kegiatan) == 'pemetaan_kelompok_sasaran')>2. Pemetaan Kelompok Sasaran</option>
                                            <option value="pengembangan_kapasitas" @selected(old('kategori_kegiatan', $kegiatan->kategori_kegiatan) == 'pengembangan_kapasitas')>3. Pengembangan Kapasitas & Pembinaan</option>
                                            <option value="monitoring_evaluasi" @selected(old('kategori_kegiatan', $kegiatan->kategori_kegiatan) == 'monitoring_evaluasi')>4. Monitoring dan Evaluasi</option>
                                        </select>
...
<script type="module">
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const oldNamaKegiatan = '{{ old('nama_kegiatan', $kegiatan->nama_kegiatan) }}';
        ...
        function updateNamaKegiatanList() {
            ...
            if (selectedKategori && jenisKegiatanMap[selectedKategori]) {
                jenisKegiatanMap[selectedKategori].forEach(namaKegiatan => {
                    ...
                    if (oldNamaKegiatan && namaKegiatan === oldNamaKegiatan) {
