                    ...
                    <div class="card shadow-lg p-5">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h5 class="card-title mb-2 text-center" id="judul">Input Data Kegiatan P2M Sosialisasi P4GN melalui kegiatan upacara/apel di sekolah</h5>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('p2m.upacara.store') }}" method="POST">
                                ...
                                <div class="row g-8 mb-5">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('nama_sekolah') is-invalid @enderror" placeholder="masukkan nama sekolah" name="nama_sekolah" value="{{ old('nama_sekolah') }}">
                                            @error('nama_sekolah')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="row g-8 mb-5">
                                    <div class="col-12 col-lg-6">
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label">Jumlah Peserta Upacara</label>
