                ...
                <div class="col-12 col-lg-10">
                    <div class="card border-0 shadow-lg">
                        ...
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <form action="{{ route('p2m.pemberdayaan.update', $kegiatan->id) }}" method="POST" enctype="multipart/form-data" id="form-edit">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row g-4 mb-4">
                                    ...
                                    <div class="col-12 mt-5">
                                        ...
                                        {{-- 1. DOKUMENTASI LAMA --}}
                                        @php $oldFotos = $kegiatan->dokumen->where('kategori', 'dokumentasi'); @endphp
                                        @if ($oldFotos->count() > 0)
                                                                ...
                                                                <div class="card h-100 shadow-sm border border-secondary-subtle position-relative overflow-hidden file-card-inner transition-all {{ $isMarkedDeleted ? 'border-danger-subtle-thick' : '' }}">
                                                                    ...
                                                                    <div class="card-body p-2 text-center d-flex flex-column justify-content-between">
                                                                        ...
                                                                        <div class="d-flex gap-1 justify-content-center position-relative" style="z-index: 10;">
                                                                            @if (!$doc->is_link) <a href="{{ route('dokumen.download', $doc->id) }}" class="btn btn-outline-primary btn-sm w-100 py-0" title="Unduh"><i class="bi bi-download"></i></a>
                                                                            @else <a href="{{ $doc->path_url }}" target="_blank" class="btn btn-outline-info btn-sm w-100 py-0" title="Buka"><i class="bi bi-box-arrow-up-right"></i></a> @endif
                                        ...
                                        {{-- 2. LAMPIRAN LAMA --}}
                                        @php $oldLampirans = $kegiatan->dokumen->where('kategori', 'lampiran'); @endphp
