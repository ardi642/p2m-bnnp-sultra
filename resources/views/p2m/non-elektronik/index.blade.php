        ...
        <div class="container-fluid p-4 p-lg-5">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                @if (auth()->user()->hasRole(['operator_satker', 'operator_p2m']))
                    <a href="{{ route('p2m.non-elektronik.create') }}"
                            ...
                            <form action="{{ route('p2m.non-elektronik.index') }}" method="GET">
                                ...
                                <div x-show="showFilter" x-transition class="mb-4 px-3 px-lg-0 pt-3 pt-lg-0">
                                    <div class="bg-body-tertiary p-4 rounded-3 border">
                                        <div class="row g-3 text-start">
                                            ...
                                            <div class="{{ $user->isAdmin() ? 'col-lg-8' : 'col-12' }}">
                                                ...
                                                <div class="input-group shadow-sm">
                                                    ...
                                                    <input type="text" name="search"
                                                        ...
                                                        placeholder="Cari Tempat Pemasangan, dll..."
                                            ...
                                            <div class="col-12 col-lg-3">
                                                <label
                                                    class="form-label fw-bold small text-secondary text-uppercase mb-1">Media</label>
                                                <div class="shadow-sm bg-white rounded">
                                                    <select id="select-media" name="jenis_media[]" multiple
                                                        placeholder="Pilih Media...">
                                                        @foreach ($mediaOptions as $key => $label)
                                                            <option value="{{ $key }}"
                                                                {{ in_array($key, request('jenis_media', [])) ? 'selected' : '' }}>
                                                                {{ $label }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                ...
                                <div
                                    ...
                                    <div class="mb-2 mb-lg-0">
                                        <button type="submit" formaction="{{ route('p2m.non-elektronik.export') }}"
                                    ...
                                    <tbody class="border-top-0">
                                        @forelse ($datas as $data)
                                            <tr class="text-center align-middle"
                                                :class="expanded.includes({{ $data->id }}) ? 'bg-light' : ''">
                                                <td class="fw-bold text-secondary ps-3">
                                                    {{ $datas->firstItem() + $loop->index }}</td>
                                                <td class="text-start"><span
                                                        class="fw-semibold text-dark">{{ $data->satuanKerja->satuan_kerja ?? '-' }}</span>
                                                </td>
                                                <td>
                                                    <span
                                                        class="badge rounded-pill {{ $data->anggaran_pelaksanaan == 'DIPA' ? 'bg-success bg-opacity-10 text-success border border-success' : 'bg-info bg-opacity-10 text-info border border-info' }}">
                                                ...
                                                <td class="small text-muted text-nowrap">
                                                    {{ $data->tanggal_mulai_pelaksanaan->locale('id')->translatedFormat('d M Y') }}
                                                </td>
                                                ...
                                                <td class="pe-3">
                                                    <div class="btn-group btn-group-sm shadow-sm">
                                                        <button type="button" class="btn btn-light border text-secondary"
                                                            @click="expanded.includes({{ $data->id }}) ? expanded = expanded.filter(id => id !== {{ $data->id }}) : expanded.push({{ $data->id }})"><i
                                                                class="bi"
                                                                :class="expanded.includes({{ $data->id }}) ?
                                                                    'bi-chevron-up text-primary' :
                                                                    'bi-eye text-secondary'"></i></button>
                                                        @if (auth()->user()->hasRole(['operator_satker', 'operator_p2m']))
                                                            <a href="{{ route('p2m.non-elektronik.edit', $data->id) }}"
                                                            ...
                                                            <form id="delete-form-{{ $data->id }}"
                                                                action="{{ route('p2m.non-elektronik.destroy', $data->id) }}"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <dl class="row mb-0 small text-start">
                                                                            ...
                                                                            <dd class="col-sm-8 text-dark">
                                                                                {{ $data->tempat_pemasangan }}</dd>

                                                                            <dt class="col-sm-4 text-secondary mb-2">
                                                                                Anggaran</dt>
                                                                            <dd class="col-sm-8 text-dark">
                                                                                {{ $data->anggaran_pelaksanaan }}</dd>

                                                                            <dt class="col-sm-4 text-secondary mb-2">
                                                                                Tanggal Mulai</dt>
                                                                            <dd class="col-sm-8 text-dark">
                                                                                {{ $data->tanggal_mulai_pelaksanaan->translatedFormat('l, d F Y') }}
                                                                            </dd>

                                                                            <dt class="col-sm-4 text-secondary mb-2">Durasi
                                                                            </dt>
                                                                            <dd class="col-sm-8 text-dark">
                                                                                {{ $data->durasi_pelaksanaan }} Hari</dd>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="row small mb-3 text-start">
                                                                            <div class="col-md-6 mb-2 text-start">
                                                                                <span class="text-secondary d-block">Dibuat
                                                                                    Pada</span>
                                                                                <span
                                                                                    class="text-dark">{{ $data->created_at->translatedFormat('l, d F Y H:i') }}</span>
                                                                            </div>
                                                                            <div class="col-md-6 mb-2 text-start">
                                                                                <span
                                                                                    ...
                                                                                    Diubah</span>
                                                                                <span
                                                                                    class="text-dark">{{ $data->updated_at->translatedFormat('l, d F Y H:i') }}</span>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div x-data="fileDownloader">
                                                                        <form action="{{ route('dokumen.zip.selected') }}"
                                                                            ...
                                                                            <div class="col-12 mt-4 text-start">
                                                                                ...
                                                                                @if ($hasPhysicalFiles)
                                                                                    <div
                                                                                        class="col-12 text-end border-top pt-3">
                                                                                        <button type="button"
...
@push('scripts')
    <script type="module">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const ids = ['select-satker', 'select-bulan', 'select-anggaran', 'select-media', 'select-tahun'];
            ids.forEach(id => {
