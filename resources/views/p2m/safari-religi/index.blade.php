...
@section('content')
    <main class="admin-main">
        <div class="container-fluid p-4 p-lg-5">
            ...
            @php
                // TAMBAHAN: 'anggaran_pelaksanaan' dimasukkan ke filter
                                                                                        ...
                                                                                        <div class="p-2 border rounded bg-light d-flex justify-content-between align-items-center h-100 shadow-sm">
                                                                                            ...
                                                                                            <div class="d-flex gap-1 flex-shrink-0">
                                                                                                @if(Str::contains($doc->tipe_file, ['image', 'pdf', 'video']))
                                                                                                    <a href="{{ Storage::url($doc->path_file) }}" target="_blank" class="btn btn-xs btn-outline-info px-2 py-0" title="Preview">
                                                                                                        <i class="bi bi-eye"></i>
                                                                                                    </a>
                                                                                                @endif
