                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-4">
                        <select class="form-select" id="p2m-select" aria-label="Default select example">
                            ...
                            <option {{ Route::is('p2m.media_non_elektronik.*') ? 'selected' : '' }} data-url="{{ route('p2m.media_non_elektronik.index') }}">Informasi dan Edukasi Melalui Media Non Elektronik</option>
