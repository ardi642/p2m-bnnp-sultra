                    ...
                    <div class="card shadow-lg p-5">
                        ...
                        <div class="card-body">
                                ...
                                <div class="row mb-5 align-items-center">
                                    <div class="col-auto">
                                        <div class="d-flex gap-2">
                                            ...
                                            <button type="submit" 
                                                    formaction="{{ route('p2m.cfd.export') }}"
                                ...
                                <table class="table table-hover mb-0" x-data="{ expanded: [] }">
                                    <thead class="table-light">
                                        <tr class="text-center align-middle">
                                            ...
                                            <th style="min-width: 200px;"   class="text-decoration-none text-dark justify-content-center align-items-center">Nama Pegawai</th>
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                ...
                                <div>
                                    {{ $cfds->fragment('data-table')->links() }}
                                </div>
