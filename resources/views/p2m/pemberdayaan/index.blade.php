        ...
        <div class="container-fluid p-4 p-lg-5">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    ...
                    <p class="text-muted mb-0">Master Data Pemberdayaan</p>
                </div>

                {{-- BAGIAN KANAN: Tombol Tambah Data --}}
                @if (auth()->user()->hasRole(['operator_satker', 'operator_p2m']))
                    <a href="{{ route('p2m.pemberdayaan.create') }}"
                        class="btn btn-primary btn-lg fs-6 px-4 rounded-pill shadow-sm d-flex align-items-center gap-2">
            ...
            @php
                ...
                $sortLink = function ($col, $label) {
                    ...
                    return '<a href="' .
                        $url .
                        '" class="text-decoration-none text-secondary fw-bold d-flex align-items-center justify-content-between gap-2">' .
                        $label .
                        ' <i class="bi ' .
                        $icon .
                        '"></i></a>';
                ...
                <div class="col-12">
                    ...
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body p-0 p-lg-4">
                            ...
                            {{-- FORM FILTER --}}
                            <form action="{{ route('p2m.pemberdayaan.index') }}" method="GET">
                                ...
                                <div x-show="showFilter" x-transition class="mb-4 px-3 px-lg-0 pt-3 pt-lg-0">
                                    <div class="bg-body-tertiary p-4 rounded-3 border">
                                        <div class="row g-3 text-start">
                                            <div class="{{ $user->isAdmin() ? 'col-lg-4' : 'col-lg-3' }}">
                                                <label class="form-label fw-bold small text-secondary text-uppercase">Kata
                                                    Kunci</label>
                                                <div class="input-group shadow-sm">
                                                    ...
                                                    <input type="text" name="search"
                                                        ...
                                                        placeholder="Cari Kegiatan, Tempat, dll..."
                                            ...
                                            <div class="{{ $user->isAdmin() ? 'col-lg-4' : 'col-lg-3' }}">
                                                <label
                                                    class="form-label fw-bold small text-secondary text-uppercase mb-1">Anggaran</label>
                                                <div class="shadow-sm bg-white rounded">
                                                    <select id="select-anggaran" name="anggaran_pelaksanaan[]" multiple
                                                        placeholder="Pilih Anggaran..." autocomplete="off">
                                                        <option value="DIPA"
                                                            {{ in_array('DIPA', request('anggaran_pelaksanaan', [])) ? 'selected' : '' }}>
                                                            DIPA</option>
                                                        <option value="NON DIPA"
                                                            {{ in_array('NON DIPA', request('anggaran_pelaksanaan', [])) ? 'selected' : '' }}>
                                                            NON DIPA</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="{{ $user->isAdmin() ? 'col-lg-4' : 'col-lg-3' }}">
                                                <label
                                                    class="form-label fw-bold small text-secondary text-uppercase mb-1">Sasaran</label>
                                                <div class="shadow-sm bg-white rounded">
                                                    <select id="select-sasaran" name="sasaran_kegiatan[]" multiple
                                                        ...
                                                        <option value="lingkungan pemerintah"
                                                            {{ in_array('lingkungan pemerintah', request('sasaran_kegiatan', [])) ? 'selected' : '' }}>
                                                            Lingkungan Pemerintah</option>
                                                        <option value="lingkungan pendidikan"
                                                            {{ in_array('lingkungan pendidikan', request('sasaran_kegiatan', [])) ? 'selected' : '' }}>
                                                            Lingkungan Pendidikan</option>
                                                        <option value="lingkungan masyarakat"
                                                            {{ in_array('lingkungan masyarakat', request('sasaran_kegiatan', [])) ? 'selected' : '' }}>
                                                            Lingkungan Masyarakat</option>
                                                        <option value="lingkungan swasta"
                                                            {{ in_array('lingkungan swasta', request('sasaran_kegiatan', [])) ? 'selected' : '' }}>
                                            ...
                                            <div class="{{ $user->isAdmin() ? 'col-lg-4' : 'col-lg-3' }}">
                                                <label
                                                    class="form-label fw-bold small text-secondary text-uppercase mb-1">Bulan</label>
                                                <div class="shadow-sm bg-white rounded">
                                                    <select id="select-bulan" name="bulan[]" multiple placeholder="Bulan..."
                                                        autocomplete="off">
                                                        @foreach (range(1, 12) as $m)
                                                            <option value="{{ $m }}"
                                                                {{ in_array($m, request('bulan', [])) ? 'selected' : '' }}>
                                            ...
                                            <div class="{{ $user->isAdmin() ? 'col-lg-4' : 'col-lg-3' }} text-start">
                                                <label
                                                ...
                                                <div class="shadow-sm bg-white rounded">
                                                    <select id="select-tahun" name="tahun[]" multiple
                                                        ...
                                                        @foreach ($years as $year)
                                                            <option value="{{ $year }}"
                                                                {{ in_array($year, request('tahun', [date('Y')])) ? 'selected' : '' }}>
                                                                {{ $year }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="{{ $user->isAdmin() ? 'col-lg-4' : 'col-lg-3' }}">
                                                <label
                                                    class="form-label fw-bold small text-secondary text-uppercase mb-1 d-block">Pegawai</label>
                                                <div class="d-flex align-items-stretch shadow-sm bg-white rounded border"
                                                    x-data="{ logic: '{{ request('pegawai_logic', 'OR') }}' }">
                                                    <button type="button"
                                                        ...
                                                        <select id="select-pegawai" name="pegawai_nips[]" multiple
                                                            ...
                                                            @foreach ($pegawais as $pgw)
                                                                <option value="{{ $pgw->nip }}"
                                                                    {{ in_array($pgw->nip, request('pegawai_nips', [])) ? 'selected' : '' }}>
                                                                    {{ $pgw->nama }} ({{ $pgw->nip }})</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="{{ $user->isAdmin() ? 'col-lg-4' : 'col-lg-3' }}">
                                                <label
                                                    class="form-label fw-bold small text-secondary text-uppercase mb-1">Sub
                                                    Kegiatan</label>
                                                <div class="shadow-sm bg-white rounded">
                                                    <select id="select-sub" name="sub_kegiatan[]" multiple
                                                        placeholder="Pilih Sub..." autocomplete="off">
                                                        <option value="pembinaan"
                                                            {{ in_array('pembinaan', request('sub_kegiatan', [])) ? 'selected' : '' }}>
                                                            Pembinaan Teknis</option>
                                                        <option value="pemetaan"
                                                            {{ in_array('pemetaan', request('sub_kegiatan', [])) ? 'selected' : '' }}>
                                                            Pemetaan Kawasan Rawan</option>
                                                        <option value="kapasitas"
                                                            {{ in_array('kapasitas', request('sub_kegiatan', [])) ? 'selected' : '' }}>
                                                            Pengembangan Kapasitas</option>
                                                        <option value="monev"
                                                            {{ in_array('monev', request('sub_kegiatan', [])) ? 'selected' : '' }}>
                                                            Monitoring & Evaluasi</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="{{ $user->isAdmin() ? 'col-lg-4' : 'col-lg-3' }}">
                                                <label
                                                    class="form-label fw-bold small text-secondary text-uppercase mb-1">Detail
                                                    Kegiatan</label>
                                                <div class="shadow-sm bg-white rounded">
                                                    <select id="select-detail" name="detail_kegiatan[]" multiple
                                                        placeholder="Pilih Detail..." autocomplete="off">

                                                        <option value="pemetaan_sdm_sda"
                                                            {{ in_array('pemetaan_sdm_sda', request('detail_kegiatan', [])) ? 'selected' : '' }}>
                                                            Pemetaan SDM dan SDA
                                                        </option>

                                                        <option value="rapat_kerja"
                                                            {{ in_array('rapat_kerja', request('detail_kegiatan', [])) ? 'selected' : '' }}>
                                                            Rapat Kerja
                                                        </option>

                                                        <option value="bimtek_life_skill"
                                                            {{ in_array('bimtek_life_skill', request('detail_kegiatan', [])) ? 'selected' : '' }}>
                                                            Bimtek Life Skill
                                                        </option>

                                                        <option value="pengukuran_skm"
                                                            {{ in_array('pengukuran_skm', request('detail_kegiatan', [])) ? 'selected' : '' }}>
                                                            Pengukuran SKM
                                                        </option>

                                                        <option value="monev_program"
                                                            {{ in_array('monev_program', request('detail_kegiatan', [])) ? 'selected' : '' }}>
                                                            Monev Program
                                                        </option>

                                                        <option value="pengukuran_ikkrn"
                                                            {{ in_array('pengukuran_ikkrn', request('detail_kegiatan', [])) ? 'selected' : '' }}>
                                                            Pengukuran IKKRN
                                                        </option>

                                                        <option value="pengukuran_kuesioner"
                                                            {{ in_array('pengukuran_kuesioner', request('detail_kegiatan', [])) ? 'selected' : '' }}>
                                ...
                                <div
                                    ...
                                    <div class="mb-2 mb-lg-0">
                                        <button type="submit" formaction="{{ route('p2m.pemberdayaan.export') }}"
                                    ...
                                    <div class="d-flex gap-2">
                                        <div
                                            ...
                                            <span class="text-dark ms-1"
                                                style="font-size: 0.9rem;">{{ number_format($totalKegiatan, 0, ',', '.') }}</span>
                                        </div>
                                        <div
                                            class="d-flex align-items-center border border-secondary-subtle rounded-3 px-3 py-1 bg-light">
                                            ...
                                            <span class="text-dark ms-1"
                                                style="font-size: 0.9rem;">{{ number_format($totalPeserta, 0, ',', '.') }}</span>
                                        </div>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    <tbody class="border-top-0">
                                        @forelse ($kegiatans as $data)
                                            ...
                                            <tr class="text-center align-middle"
                                                :class="isExpanded({{ $data->id }}) ? 'bg-light' : ''">
                                                <td class="fw-bold text-secondary ps-3">
                                                    {{ $kegiatans->firstItem() + $loop->index }}</td>
                                                <td class="text-start"><span
                                                        class="fw-semibold text-dark">{{ $data->satuanKerja->satuan_kerja ?? '-' }}</span>
                                                </td>
                                                <td><span
                                                        class="badge rounded-pill {{ $data->anggaran_pelaksanaan == 'DIPA' ? 'bg-success bg-opacity-10 text-success border border-success border-opacity-25' : 'bg-info bg-opacity-10 text-info border border-info border-opacity-25' }}">{{ $data->anggaran_pelaksanaan }}</span>
                                                </td>

                                                <td class="text-start"><a href="#"
                                                        class="text-decoration-none fw-bold text-dark"
                                                        @click.prevent="toggleExpand({{ $data->id }})">{{ $data->nama_kegiatan }}</a>
                                                </td>
                                                ...
                                                <td>
                                                    @php
                                                        $sasaranClass = match ($data->sasaran_kegiatan) {
                                                            ...
                                                            'lingkungan pemerintah' => 'bg-primary',
                                                            'lingkungan masyarakat' => 'bg-success',
                                                            'lingkungan swasta' => 'bg-info',
                                                        };
                                                    @endphp
                                                    <span
                                                        class="badge rounded-pill {{ $sasaranClass }} bg-opacity-10 {{ str_replace('bg-', 'text-', $sasaranClass) }} border {{ str_replace('bg-', 'border-', $sasaranClass) }} border-opacity-25 text-capitalize text-nowrap">{{ $data->sasaran_kegiatan }}</span>
                                                </td>
                                                <td class="small text-muted text-nowrap">
                                                    {{ $data->tanggal_pelaksanaan->locale('id')->translatedFormat('d M Y') }}
                                                </td>
                                                ...
                                                <td class="text-start">
                                                    <div class="d-flex flex-wrap gap-1">
                                                        ...
                                                        @foreach ($displayedPegawai as $pegawai)
                                                            <span
                                                                class="badge bg-white border text-secondary fw-normal shadow-sm">{{ $pegawai->nama }}</span>
                                                        @endforeach

                                                        @if ($remaining > 0)
                                                            <a href="#"
                                                                class="badge bg-secondary bg-opacity-10 text-secondary border border-secondary border-opacity-25 text-decoration-none"
                                                                @click.prevent="toggleExpand({{ $data->id }})">
                                                                +{{ $remaining }} lainnya
                                                            </a>
                                                        @endif
                                                    </div>
                                                ...
                                                <td class="pe-3">
                                                    <div class="btn-group btn-group-sm shadow-sm">
                                                        ...
                                                        @if (auth()->user()->hasRole(['operator_satker', 'operator_p2m']))
                                                            <a href="{{ route('p2m.pemberdayaan.edit', $data->id) }}"
                                                            ...
                                                            <form id="delete-form-{{ $data->id }}"
                                                                action="{{ route('p2m.pemberdayaan.destroy', $data->id) }}"
                                                    ...
                                                    <div class="bg-body-tertiary p-4 border-bottom shadow-inner text-start"
                                                        ...
                                                        <div class="card border-0 shadow-sm">
                                                            <div class="card-body">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <dl class="row mb-0 small text-start">
                                                                            ...
                                                                            <dd class="col-sm-8 text-dark">
                                                                                {{ $data->nama_kegiatan }}</dd>
                                                                            <dt class="col-sm-4 text-secondary mb-2">Sub
                                                                                Kegiatan</dt>
                                                                            <dd class="col-sm-8 text-dark text-capitalize">
                                                                                {{ $data->sub_kegiatan_label }}
                                                                            </dd>

                                                                            <dt class="col-sm-4 text-secondary mb-2">Detail
                                                                            </dt>
                                                                            <dd class="col-sm-8 text-dark">
                                                                                {{ $data->detail_kegiatan_label }}
                                                                            </dd>
                                                                            ...
                                                                            <dd class="col-sm-8"><span
                                                                                    class="badge bg-light text-dark border">{{ $data->anggaran_pelaksanaan }}</span>
                                                                            </dd>
                                                                            <dt class="col-sm-4 text-secondary mb-2">
                                                                                Sasaran</dt>
                                                                            <dd class="col-sm-8 text-capitalize text-dark">
                                                                                {{ $data->sasaran_kegiatan }}</dd>
                                                                            <dt class="col-sm-4 text-secondary mb-2">Tempat
                                                                            </dt>
                                                                            <dd class="col-sm-8 text-dark">
                                                                                {{ $data->tempat_kegiatan }}</dd>
                                                                            <dt class="col-sm-4 text-secondary mb-2">
                                                                                Tanggal</dt>
                                                                            <dd class="col-sm-8 text-dark">
                                                                            ...
                                                                            <dt class="col-sm-4 text-secondary mb-2">
                                                                                Peserta</dt>
                                                                            <dd class="col-sm-8 text-dark">
                                                                                {{ $data->jumlah_peserta }} Orang</dd>
                                                                        </dl>
                                                                    </div>
                                                                    <div class="col-lg-6">
                                                                        <div class="row small mb-3 text-start">
                                                                            <div class="col-md-6 mb-2 text-start"><span
                                                                                    class="text-secondary d-block">Dibuat
                                                                                    Pada</span><span
                                                                                    class="text-dark">{{ $data->created_at->locale('id')->translatedFormat('l, d F Y H:i') }}</span>
                                                                            </div>
                                                                            <div class="col-md-6 mb-2 text-start"><span
                                                                                    class="text-secondary d-block">Terakhir
                                                                                    Diubah</span><span
                                                                                    class="text-dark">{{ $data->updated_at->locale('id')->translatedFormat('l, d F Y H:i') }}</span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="mb-4 text-start">
                                                                            <span
                                                                                class="fw-bold text-secondary small d-block mb-2 text-start">List
                                                                                Pegawai Terlibat:</span>

                                                                            {{-- LIST DETAIL: KEMBALI KE LIST VERTIKAL (UL/LI) --}}
                                                                            <ul
                                                                                class="list-unstyled mb-0 small text-start">
                                                                                @foreach ($allPegawai as $pegawai)
                                                                                    @php $isPindah = $pegawai->satuan_kerja_id != $data->satuan_kerja_id; @endphp
                                                                                    <li class="mb-2 text-start">
                                                                                        <i
                                                                                            class="bi bi-person-check-fill me-2 text-success"></i><span
                                                                                            class="text-dark">{{ $pegawai->nama }}</span>
                                                                                        <span
                                                                                            class="text-muted">({{ $pegawai->nip }})</span>
                                                                                        @if ($isPindah)
                                                                                            <br><small
                                                                                                class="text-danger fw-bold fst-italic ms-4"><i
                                                                                                    class="bi bi-arrow-return-right me-1"></i>Pindah
                                                                                                ke:
                                                                                                {{ $pegawai->satuanKerja->satuan_kerja ?? 'Luar Satker' }}</small>
                                                                                        @endif
                                                                                    </li>
                                                                                @endforeach
                                                                            </ul>
                                                                ...
                                                                <form action="{{ route('dokumen.zip.selected') }}"
                                                                    method="POST" x-ref="formZip">
                                                                    @csrf
                                                                    <div class="col-12 mt-4 text-start">
                                                                        <div class="row g-4">

                                                                            @php
                                                                                $fotos = $data->dokumen->where(
                                                                                    'kategori',
                                                                                    'dokumentasi',
                                                                                );
                                                                                $lampirans = $data->dokumen->where(
                                                                                    'kategori',
                                                                                    'lampiran',
                                                                                );
                                                                                $fotoIds = $fotos
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                <div
                                                                                    class="card h-100 border bg-light shadow-none">
                                                                                    <div
                                                                                        class="card-header bg-transparent border-bottom fw-bold text-primary d-flex justify-content-between align-items-center">
                                                                                        <div class="form-check">
                                                                                            ...
                                                                                            @endif
                                                                                            <label
                                                                                                class="form-check-label cursor-pointer select-none"><i
                                                                                                    class="bi bi-images me-2"></i>Dokumentasi</label>
                                                                                        </div>
                                                                                        <span
                                                                                            class="badge bg-primary rounded-pill">{{ $fotos->count() }}</span>
                                                                                    </div>
                                                                                    <div class="card-body p-2"
                                                                                        style="max-height: 30vh; min-height: 100px; overflow-y: auto;">
                                                                                        @forelse($fotos as $doc)
                                                                                            <div class="d-flex align-items-center bg-white border rounded p-2 mb-2 shadow-sm hover-shadow transition-all"
                                                                                                ...
                                                                                                @if (!$doc->is_link)
                                                                                                    <div
                                                                                                        class="form-check me-2 d-flex align-items-center">
                                                                                                        <input
                                                                                                ...
                                                                                                @endif
                                                                                                <div class="flex-grow-1 text-truncate small cursor-pointer"
                                                                                                    @if (!$doc->is_link) @click="toggle({{ $doc->id }})" @endif>
                                                                                                    <div
                                                                                                        class="d-flex align-items-center">
                                                                                                        <div
                                                                                                            class="flex-shrink-0 me-2 text-primary bg-primary bg-opacity-10 p-1 rounded">
                                                                                                            @if ($doc->is_link)
                                                                                                                <i
                                                                                                        ...
                                                                                                        <span
                                                                                                            class="text-truncate"
                                                                                                            title="{{ $doc->nama_file_asli }}">{{ $doc->nama_file_asli }}</span>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div
                                                                                                    class="d-flex gap-1 flex-shrink-0 ms-2">
                                                                                                    @if (!$doc->is_link)
                                                                                                        <a href="{{ Storage::disk($doc->disk ?? 'public')->url($doc->path_file) }}"
                                                                                                            target="_blank"
                                                                                                    ...
                                                                                                    @else
                                                                                                        <a href="{{ $doc->path_url }}"
                                                                                                            target="_blank"
                                                                                                            class="btn btn-xs btn-outline-info w-100"><i
                                                                                                                class="bi bi-box-arrow-up-right me-1"></i>Buka</a>
                                                                                                    @endif
                                                                                                </div>
                                                                                            </div>
                                                                                        @empty
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                <div
                                                                                    class="card h-100 border bg-light shadow-none">
                                                                                    <div
                                                                                        class="card-header bg-transparent border-bottom fw-bold text-danger d-flex justify-content-between align-items-center">
                                                                                        <div class="form-check">
                                                                                            @if (count($lampiranIds) > 0)
                                                                                                <input
                                                                                                    ...
                                                                                                    :checked="isAllSelected(
                                                                                                        {{ json_encode($lampiranIds) }}
                                                                                                    )">
                                                                                            @endif
                                                                                            <label
                                                                                                class="form-check-label cursor-pointer select-none"><i
                                                                                                    class="bi bi-paperclip me-2"></i>Lampiran</label>
                                                                                        </div>
                                                                                        <span
                                                                                            class="badge bg-danger rounded-pill">{{ $lampirans->count() }}</span>
                                                                                    </div>
                                                                                    <div class="card-body p-2"
                                                                                        style="max-height: 40vh; min-height: 100px; overflow-y: auto;">
                                                                                            ...
                                                                                            <div class="d-flex align-items-center bg-white border rounded p-2 mb-2 shadow-sm hover-shadow transition-all"
                                                                                                ...
                                                                                                <div class="flex-grow-1 text-truncate small cursor-pointer"
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="d-flex align-items-center">
                                                                                                        <div
                                                                                                            class="flex-shrink-0 me-2 text-danger bg-danger bg-opacity-10 p-1 rounded">
                                                                                                            @if ($doc->is_link)
                                                                                                                <i
                                                                                                                    class="bi bi-link-45deg"></i>
                                                                                                            ...
                                                                                                            @elseif(Str::contains($doc->tipe_file, ['word', 'office']))
                                                                                                                <i
                                                                                                                    class="bi bi-file-word"></i>
                                                                                                            @else
                                                                                                                <i
                                                                        ...
                                                                        @if ($hasPhysicalFiles)
                                                                            <div class="col-12 text-end border-top pt-3">
                                                                                <button type="button"
                                                                                    ...
                                                                                    class="btn btn-dark btn-sm px-4 shadow-sm"
                                                                                    :disabled="selected.length === 0">
                                                                                    <i
                                                                                        class="bi bi-file-earmark-zip-fill me-2"></i>Download
                                                                                    File Terpilih (.ZIP)
                                                                                </button>
                                                                            </div>
                                                                        @endif
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="11"
                                                    class="text-center py-5 text-muted fst-italic border-bottom">Tidak ada
                                                    data kegiatan.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                            ...
                            <div class="card-footer bg-white py-3 border-top-0">
                                <div
                                    class="d-flex flex-column flex-lg-row justify-content-between align-items-center gap-3">
                                    <div class="d-flex align-items-center gap-2">
                                        <select class="form-select form-select-sm border-secondary-subtle"
                                            style="width: 70px;" onchange="window.location.href = this.value">
                                            @foreach ([10, 25, 50, 100] as $num)
                                                <option
                                                    value="{{ request()->fullUrlWithQuery(['per_page' => $num, 'page' => 1]) }}"
    ...
    <script type="module">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            if (typeof TomSelect !== 'undefined') {
                ...
                const ids = ['select-satker', 'select-bulan', 'select-anggaran', 'select-sasaran', 'select-tahun',
                    'select-pegawai', 'select-sub', 'select-detail'
                ];
                ids.forEach(id => {
