        ...
        <div class="container-fluid p-4 p-lg-5">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">Master Data KIE Keliling</p>
                </div>
            </div>
                    ...
                    <div class="card shadow-lg p-5">
                        <div class="card-header bg-white border-0">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h5 class="card-title mb-0 text-center">Data KIE (Kegiatan Informasi dan Edukasi)
                                        Keliling</h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('p2m.kie.index') }}" method="GET" class="mb-8">
                                ...
                                <div class="row mb-5 align-items-center">
                                    <div class="col-auto">
                                        <div class="d-flex gap-2">
                                            ...
                                            <button type="submit" formaction="{{ route('p2m.kie.export') }}"
                                            ...
                                            @if ($user->isAdmin())
                                                <div class="col-md-6">
                                                    ...
                                                    <select id="select-satker" name="satuan_kerja_id[]" multiple
                                                        ...
                                                        @foreach ($satuanKerjas as $satkerS)
                                ...
                                <table class="table table-hover mb-0" x-data="{ expanded: [] }">
                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($kies as $data)
                                            <tr class="text-center">
                                                <td>{{ $kies->firstItem() + $loop->index }}</td>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2 justify-content-center">
                                                        ...
                                                        <a href="{{ route('p2m.kie.edit', $data->id) }}"
                                                            class="btn btn-success btn-sm"><i
                                                                class="me-0 bi bi-pencil-square"></i></a>
                                                        <form id="delete-form-{{ $data->id }}"
                                                            action="{{ route('p2m.kie.destroy', $data->id) }}"
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                ...
                                <div>
                                    {{ $kies->fragment('data-table')->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
