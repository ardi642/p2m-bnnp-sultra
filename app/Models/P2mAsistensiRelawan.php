...
class P2mAsistensiRelawan extends Model
{
    use HasFactory;
    use HasDokumen;
    protected $table = 'p2m_asistensi_relawan';
     ...
     * Menggunakan tabel pivot 'pegawai_p2m_asistensi_relawan'
     */
    public function pegawai(): BelongsToMany
    {
        return $this->belongsToMany(
            Pegawai::class,                // Model Tujuan
            'pegawai_p2m_asistensi_relawan',     // Nama Tabel Pivot
            'p2m_asistensi_relawan_id',          // Foreign Key tabel ini di Pivot
