                ...
                <div class="col-12 col-lg-10">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            ...
                            <p class="text-muted mb-0">Edit Data P2m</p>
                        </div>
                        {{-- PERBAIKAN: Tombol Kembali ke Index Murni --}}
                        <a href="{{ route('p2m.elektronik.index') }}" class="btn btn-outline-secondary btn-sm">
                ...
                <div class="col-12 col-lg-10">
                    <div class="card shadow-lg p-5">
                        <div class="card-header">
                            <h5 class="card-title mb-2">Edit Informasi Edukasi Melalui Media Elektronik</h5>
                        </div>
                        <div class="card-body">
                            {{-- Form Edit --}}
                            <form id="form-edit-p2m" action="{{ route('p2m.elektronik.update', $kegiatan->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row g-6 mb-5">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <div class="mb-0">
                                                ...
                                                <select class="form-select @error('Media') is-invalid @enderror" name="Media">
                                                    @php $val = old('Media', $kegiatan->Media); @endphp
                                                    <option value="Televisi" @selected($val == 'Televisi')>Televisi</option>
                                                    <option value="Radio" @selected($val == 'Radio')>Radio</option>
                                                    <option value="Video Tron" @selected($val == 'Video Tron')>Video Tron</option>
                                                    <option value="Bioskop" @selected($val == 'Bioskop')>Bioskop</option>
                                                    <option value="Tv Plasma" @selected($val == 'Tv Plasma')>Tv Plasma</option>
                                                    <option value="Media Lain" @selected($val == 'Media Lain')>Media Lain</option>
                                                </select>
                                        ...
                                        <div class="mb-0">
                                           <label class="form-label">Nama Media</label>
                                                <input type="text" class="form-control @error('nama_media') is-invalid @enderror" 
                                                       name="nama_media" 
                                    ...
                                    <div class="mb-3">
                                       <label for="exampleFormControlInput1" class="form-label">Masukan Durasi Pelaksanaan (Hari) </label>
                                        <input type="number" class="form-control @error('durasi_pelaksanaan') is-invalid @enderror" placeholder="Masukkan Durasi Pelaksanaan (hari)" name="durasi_pelaksanaan" value="{{ old('durasi_pelaksanaan',$kegiatan->durasi_pelaksanaan )}}">
                                ...
                                <div class="row justify-content-end">
                                    ...
                                    <div class="col-12 col-lg-auto">
                                        ...
                                        <a href="{{ route('p2m.elektronik.edit', $kegiatan->id) }}" class="btn btn-secondary w-100 mb-4 mb-lg-0">
                                            Reset Data
                                        </a>
                                    </div>
                                </div>
